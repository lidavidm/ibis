...
class Backend(BaseSQLBackend):
    ...
    def do_connect(self, driver, entrypoint, **kwargs) -> None:
    ...
    def fetch_from_cursor(
        self, cursor: _StatementReader, schema: sch.Schema
    ) -> pd.DataFrame:
        return cursor.reader.read_pandas()
...
class _StatementReader(typing.NamedTuple):
